...
def parse():
    ...
    url = 'https://samolet.ru/api_redesign/flats/?project=68189&from=project&ordering=-order_manual,filter_price_package,pk&free=1&offset=0&limit=12'
    ...
    for i in range(0, (count_pages+1)*12, 12):
        url = 'https://samolet.ru/api_redesign/flats/?project=68189&from=project&ordering=-order_manual,filter_price_package,pk&free=1&offset=' + str(i) + '&limit=12'
    ...
    writer = pd.ExcelWriter(f'data/{str(date.today())}_smlt_d_yauzyзшз3 .xlsx')
    ...
    '*Данные взяты с сайта samolet.ru/project/dolina-yauzy/.')
